...
--글번호 그룹번호 그룹순서 제목 공백 제목 내용 작성자 작성일 
...
VALUES(BOARDNOSEQ.NEXTVAL, GROUPNOSEQ.NEXTVAL, 1, 0, 
		'1번글 입니다.', '1번 글을 썻는데...답변형 어렵다.', '강사', SYSDATE);
...
--UPDATE
--INSERT
--그룹 번호 : 답변을 달려고 하는 부모글의 그룹번호
--그룹 순서 : 답변을 달려고 하는 부모글의 그룹순서 +1
--제목 공백: 답변을 달려고 하는 부모글의 공백 +1
INSERT INTO ANSWERBOARD
VALUES(
		BOARDNOSEQ.NEXTVAL,
